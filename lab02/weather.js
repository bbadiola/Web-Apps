var APPID = '&appid=8adc25598035f4e4534be50419a04308';
var cityTemp;
...
function weatherRequest(){
	...
	xhttp.open("GET", "http://api.openweathermap.org/data/2.5/forecast?q=" + cityToSearch + APPID, true);
...
function getIcon(day, weekDay){
	if(	weather.list[day].weather[0].main=="Clouds"){		
		document.getElementById(weekDay).src = "img/Mostly Cloudy.png";
	}	
	else if(weather.list[day].weather[0].main=="Clear"){		
		document.getElementById(weekDay).src = "img/Clear.png";
	}	
		...
		document.getElementById(weekDay).src = "img/Rain.png";
	}	
